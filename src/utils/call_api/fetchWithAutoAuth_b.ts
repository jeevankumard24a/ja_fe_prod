...
async function mintAccessTokenViaInternalRoute(
    ...
    try {
        ...
        throw new ApiError(503, "Failed to connect to backendddddddddddddddddddd (refresh)", "NETWORK_ERROR", { error: err }, requestId, actionId);
    }
...
export async function fetchWithAutoAuth(
    ...
    console.log("Testinggggggggggggggg1")
